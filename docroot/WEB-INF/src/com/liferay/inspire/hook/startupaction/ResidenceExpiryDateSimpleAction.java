...
public class ResidenceExpiryDateSimpleAction extends SimpleAction {

	public ResidenceExpiryDateSimpleAction() {
		super();
	}
	...
	public void run(String[] ids) throws ActionException {
		...
		try{
			...
			try{
				expandoColumn = ExpandoColumnLocalServiceUtil.addColumn(tableId, "residence-exp-date", ExpandoColumnConstants.DATE);
			}
			catch (DuplicateColumnNameException dcne) {
				expandoColumn = ExpandoColumnLocalServiceUtil.getColumn(tableId, "residence-exp-date");
